# STORY-03-01 Policy Contract and Lineage Fields
...
## Story goal
- Lock policy/prompt contract fields with explicit lineage requirements.

## Scope anchor
- `PLANS/policier/policy_assembly.md`
- `PLANS/policier/prompt_generation.md`
- `PLANS/testing/test_policy.md`

## Task packet (context-minimized)
- included docs: `policy_assembly.md`, `prompt_generation.md`
- included policy refs: `test_policy.md`
- included contract/fixture refs: `contracts/policy/*`, `contracts/prompts/*`, `tests/io/policy/*`, `tests/io/prompts/*`
- explicitly excluded context: topic evaluation specifics
...
## Notes
- dependencies: snippet outputs available
- follow-up stories: policy/prompt implementation
